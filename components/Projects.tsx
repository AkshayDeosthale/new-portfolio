...
const Projects = () => {  
  return <>
  {/* pc view */}
  <motion.div className=" mx-auto hidden md:grid md:grid-col-2 lg:grid-cols-3  lg:gap-16 " data-aos="zoom-out-down">
  ...
  <motion.div className=" mt-64 md:hidden grid grid-col-1 gap-5 " >
   { projects.map((pro,key)=> <motion.div key={key} className='h-[450px] group w-full  backdrop-blur-md backdrop-contrast-150 active:scale-95 transition-all duration-300 ' >
      <div className="w-full h-1/2 ">
      ...
      <div className="p-3 flex flex-col space-y-4">
        ...
        <div className="flex space-x-2 ">
        <button className=" py-2 flex-1 backdrop-sepia bg-blue-500 hover:bg-blue-600 text-white font-semibold active:scale-95 transition-all duration-150">Visit</button>
        <button className=" py-2 flex-1 backdrop-sepia bg-purple-500 hover:bg-purple-600 text-white font-semibold active:scale-95 transition-all duration-150"><Link
        to="contact"
        smooth={true}       
      >
        Contact
